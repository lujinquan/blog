...
<?php endif; switch($hisiTabType): case "1": ?>
  ...
  <div class="layui-form-item">
	...
	<div class="layui-inline">
      ...
      <div class="layui-form-mid layui-word-aux">请正确填写url</div>
    </div>
  </div>
